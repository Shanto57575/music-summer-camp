...
const Footer = () => {
	return (
		<footer className="lg:flex items-center justify-around p-10 bg-neutral text-neutral-content space-y-5 lg:space-y-0">
			<div className="sm:w-full sm:mx-auto lg:w-80 mx-0">
				<div className="flex items-center">
					<img className="w-20" src={musicLogo} alt="" />
					<p className="text-xl">MelodicMuse</p>
				</div>{" "}
